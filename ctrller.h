...
/* Updated 14/3/97 to include the Namco gun
/* Updated 24/3/97 to include The Konami gun
/* Updated 4/4/97  tp include MultiTap button recognision ( see bottom )
/*
** 20-nov-1995 (pholman)
...
#define ANALOG_JOY               5
#define GUNCON                   6
#define ANALOG_CTL               7 /* added by GJV */
#define MULTI_TAP                8
...
#define GUNCON_TRIGER               0x2000                                    
#define GUNCON_B                    0x4000                                    

//#define GunConScreenDiv(x)                ((x)->data.guncon.GunConScreenDiv)
//#define GunConY(x)                        ((x)->data.guncon.GunconY)

#define GunConX(x)                  ((x)->data.guncon.GunconX)
#define GunConY(x)                  ((x)->data.guncon.GunconY)
#define GunConScreenDiv(x)          ((x)->data.guncon.GunConScreenDiv)
...
/* the gun coordinate are set in a seperate buffer defined by the programmer
**  Please see my gun Code to find out how to read it
*/

#define KONAMI_TRIGGER  0x8000          // trigger for the Konami Gun
#define KONAMI_PIN      0x4000          // Pin/Back button for the Konami Gun
#define KONAMI_START    0x0008          // start for the Konami Gun
...
/*+--------+----------+----------+----------+----------+----------+---------+*/
/*+--------+----------MultiTap Button recognision Data--------+----------+---*/



#define MultiPortAIsPressed(x,y)   (!((x)->data.tap.ctrllers[0].data.pad & (y)))
#define MultiPortBIsPressed(x,y)   (!((x)->data.tap.ctrllers[1].data.pad & (y)))
#define MultiPortCIsPressed(x,y)   (!((x)->data.tap.ctrllers[2].data.pad & (y)))
#define MultiPortDIsPressed(x,y)   (!((x)->data.tap.ctrllers[3].data.pad & (y)))
